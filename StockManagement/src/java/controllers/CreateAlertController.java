 ...
 * @author admin
 */
@WebServlet("/CreateAlertController")
public class CreateAlertController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Alert alert = new Alert(0, loginUser.getUserID(), ticker, threshold, direction, "inactive");
            ...
            ArrayList<Alert> list = dao.getAllAlertsByUser(loginUser.getUserID());
